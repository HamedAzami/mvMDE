function [Out_mvDE, npdf]=mvDE_NCDF(X,m,c,stau)
% This function calculates multivariate dispersion entropy (mvDE) using normal cumulative distribution function (NCDF).
%
% mvDE deals with the shortcomings of mvDE_I, mvDE_II, and mvDE_III although each of these four methods has its own pros and cons.
%
% Inputs:
